...
<head>
    ...
    <title>Bespoke Suits for Freaky Little Dogs! (A sample app for CodeDeploy)</title>
...
<body role="document">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Bespoke Suits for Freaky Little Dogs</a>
      </div>
  ...
  <div class="container theme-showcase" role="main">
    ...
    <% } %>
    <div class="jumbotron">
      <h1>Bespoke Suits for Freaky Little Dogs</h1>
